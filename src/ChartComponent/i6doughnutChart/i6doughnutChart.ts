...
@Component({
  selector: 'i6doughnutChart',
  templateUrl: 'i6doughnutChart.html',
})

export class i6DoughnutChart {
  ...
  @ViewChild('i6doughnutCanvas') i6doughnutCanvas :  ElementRef;

  public i6doughnutChart: any;
    ...
    getDoughnutChart(doughnutValue, doughnutDisc, doughnutTotal, doughnutTitle,doughnutLabel1,doughnutLabel2) { 
            ...
            let options = {     
                ...
                title: {    
                  display: true,
                  position: 'bottom',
                  text: doughnutTitle + ' ' + doughnutDisc +' Mins out of '+doughnutTotal + ' ABC Files ',
                  fontColor: 'black',
                  fontSize: 20,
                  fontStyle: 'Helvetica'
              },
      ...
      return this.getChart(this.i6doughnutCanvas.nativeElement, "doughnut", data, options);     
    }
